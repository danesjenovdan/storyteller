...
ALLOWED_HOSTS: List[str] = os.getenv("DOMAIN_NAME", "localhost").split(",")
CSRF_TRUSTED_ORIGINS = os.getenv("DJANGO_BASE_URL", "http://localhost").split(",")
...
HUEY_RECOVERY_STALE_MINUTES = int(
    os.getenv("HUEY_RECOVERY_STALE_MINUTES", "10")
)
HUEY_RECOVERY_STARTUP_STALE_MINUTES = int(
    os.getenv("HUEY_RECOVERY_STARTUP_STALE_MINUTES", "0")
)
HUEY_RECOVERY_MAX_ATTEMPTS = int(
    os.getenv("HUEY_RECOVERY_MAX_ATTEMPTS", "3")
)
